...
def smiles2higraph(smiles_string)->Dict:
    """
    ...
    graph = dict()
    graph['edge_index'] = mol.edge_index.numpy()
    graph['edge_feat'] = mol.edge_attr.numpy()
    graph['node_feat'] = mol.x.numpy()
    graph['num_nodes'] = mol.num_part
