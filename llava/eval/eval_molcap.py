...
def add_arguments(parser):
    ...
    parser.add_argument("--molcap_score_file", type=str, required=True)
...
if __name__ == "__main__":
    ...
    with open(args.molcap_score_file, 'w') as json_file:
        json.dump(result, json_file, indent=4)

    print(f"Results have been saved to {args.molcap_score_file}")
