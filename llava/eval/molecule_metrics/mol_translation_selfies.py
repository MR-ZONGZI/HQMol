...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_result_file', type=str, default='caption2smiles_example.json', help='path where test generations are saved')
    parser.add_argument('--score_result_file', type=str, default='caption2smiles_example.json', help='path where test generations are saved')
    args = parser.parse_args()
    # test_out_selfies_validity(args)
    evaluate(args.eval_result_file, verbose=True)
